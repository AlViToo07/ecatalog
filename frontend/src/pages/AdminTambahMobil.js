...
const AdminTambahMobil = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('/api/mobil', dataToSend);
  ...
  return (
    <div className="form-mobil">
      <div className="container">
        <h1 className="page-title">Tambah Mobil Toyota Baru</h1>
...
export default AdminTambahMobil;
